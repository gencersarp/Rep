...
def player(prev_opponent_play, opponent_history=[]):
  ...
  if (len(set(opponent_list)) == 1
      and opponent_history[-5:] == ['R', 'P', 'P', 'S', 'R']):
  ...
  if (len(set(opponent_list)) == 1
      and opponent_history[-5:] == ['P', 'P', 'R', 'R', 'R']):
  ...
  if (opponent_list[1]):
    ...
    return prev_play
  if (len(set(opponent_list)) == 1
      and opponent_history[-5:] == ['P', 'R', 'R', 'R', 'R']):
  ...
  if (len(set(opponent_list)) == 1
      and opponent_history[-5:] == ['R', 'R', 'R', 'R', 'R']):
